--[[
    ...
    ┌─────────────────────────────────────────────────────────────┐
    │  Standard  │  NNNN MON   │  3456 OCT   │  8 chars  │  auto │
    ...
    Year is omitted from the standard display to stay within the limit.
--]]
...
--- Returns a plate in "NNNN MON" format, e.g. "3456 OCT"  (exactly 8 chars).
function MauPlate.GenerateStandard()
    ...
    return num .. ' ' .. month   -- 4 + 1 + 3 = 8 chars exactly
end
